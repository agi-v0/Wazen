			...
			{(await draftMode()).isEnabled && (
				<>
					...
					<a
						...
						className="fixed right-0 bottom-7 left-0 z-10 mx-auto flex w-fit flex-row items-center gap-1 rounded-full bg-amber-200 px-3 py-1.5 text-sm font-medium text-amber-950/60 uppercase shadow-xs transition-colors hover:bg-amber-300"
					>
						<Icon
