					...
					<div className="relative mt-6 flex w-full flex-col gap-9 text-sm">
						{details?.slice(1).map((detail: any, index: any) => (
							<div key={'details_' + index} id={'details_' + index}>
								...
								<h3
									className="text-main sticky top-[calc(var(--header-height)+106.31px)] z-1 flex w-full flex-col justify-end rounded-2xl bg-teal-100 p-(--text-main--font-size) font-semibold text-gray-900 max-lg:top-(--header-height)"
									aria-hidden="true"
								>
									{detail.title}
								</h3>
