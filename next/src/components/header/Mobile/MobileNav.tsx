...
const mobileFeaturedLinkStyle = cn(
	...
	'group relative flex flex-col justify-end rounded-lg bg-linear-to-b from-cyan-800 to-cyan-950 p-4',
												...
												return (
													...
													>
														...
														<div
															...
															className="data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out data-[state=open]:fade-in overflow-hidden transition-all"
														>
