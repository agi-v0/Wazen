...
export default function CallToAction({
	...
	return (
		<section className="section">
			<div className="fluid-gap fluid-padding relative mx-auto flex w-full max-w-screen-xl flex-col-reverse items-center justify-evenly overflow-hidden rounded-2xl lg:flex-row">
