...
import CalculatorTable from '@/components/modules/pricing/CalculatorTable'
	...
	return (
		<div className="section py-24">
			...
			<div className="container">
				...
				<div className="sticky top-(--header-height) z-2 flex w-full flex-row items-end justify-between bg-white">
